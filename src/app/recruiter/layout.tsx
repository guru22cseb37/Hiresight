    ...
    return (
      <div className="flex items-center justify-center h-screen bg-background">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-slate-500 font-medium animate-pulse">Initializing Recruiter Intelligence...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden font-sans">
      ...
      <main className="flex-1 md:ml-64 overflow-y-auto overflow-x-hidden relative h-full">
        ...
        <TopBar name={userProfile?.name} email={userProfile?.email} role="recruiter" />
